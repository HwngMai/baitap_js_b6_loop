...
document.getElementById('btnBaiTap1').onclick = function (){
    ...
    document.getElementById('ketQuaBaiTap1').innerHTML = 'Số cần tìm là: ' + soCanTim ;
}
//Bài 2
...
document.getElementById('btnBaiTap4').onclick = function(){
    ...
    for ( i = 1 ; i <=10 ; i++){
        if( i % 2 == 0){
        ketQua += '<div class="bg-danger">' + 'div chẵn ' + Math.ceil(i/2) + '</div>';
    }   else {
        ketQua += '<div class="bg-primary">' + 'div lẻ ' + Math.ceil(i/2) + '</div>';
    }
    }
